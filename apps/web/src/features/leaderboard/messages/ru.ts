...
export default {
  ...
  indexDifference: "Разница · баллы",
  incomparableScores: "Эти языковые оценки получены на несопоставимых наборах тестов.",
  differenceHelp:
    "Разница сводных баллов, а не проверка значимости. Парные сравнения отдельных тестов — на странице модели.",
  compareLanguages: "Сравнить языки",
  closeComparison: "Закрыть сравнение",
  searchLanguages: "Найти язык…",
  baseline: "Сравнить: исходный язык",
  candidate: "Сравнить с языком",
